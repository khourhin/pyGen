...
if __name__ == "__main__":
    ...
    parser.add_argument("-v","--vcf",
                        help="A vcf file with SNPs, tab delimited")
    ...
    elif args.db and args.vcf and args.go_terms:
        snps_zip = import_snps_location(args.vcf)
        go_dict = import_go_terms(args.go_terms)
        fetch_snps_location(args.db, snps_zip, go_dict)
    else:
        raise IOError("Something is wrong with your arguments ...")
